# Generated by Powerlevel10k configuration wizard on 2023-03-17 at 13:02 EDT.
...
#   context                 # user@hostname
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%a %b %d, %H:%M:%S}'
  ...
  # Custom prefix.
  #typeset -g POWERLEVEL9K_TIME_PREFIX='%a%d '
